...
const BlogTemplate = ({title}) => {
  ...
  return (
    <div className="p-4 borderCss mb-8">
      ...
      <div className="flex flex-col gap-2 lg:gap-6 items-center justify-between lg:flex-row ">
        <div className="max-w-sm w-full lg:w-1/3 flex-col items-center justify-center lg:max-w-full lg:flex borderCss">
          <div className="h-52 lg:h-[203px]   lg:w-96 p-2 sm:w-full bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden">
            <Image
        ...
        {isLargeScreen && (
          <div className="flex flex-col gap-2 items-center justify-between max-h-96 overflow-y-auto">
            <Blog2 />
            <Blog2 />
            <Blog2 />
            <Blog2 />
