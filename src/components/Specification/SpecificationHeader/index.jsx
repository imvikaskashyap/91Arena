      ...
      <div
        ...
        >
          <div className="w-full h-11 bg-gradient-to-r from-blue-500 to-purple-500 border-b">
            <h1 className="px-4 text-2xl text-white font-bold">Samsung Galaxy S24</h1>
          </div>
          <div className="flex justify-between p-4">
            ...
            <div className="flex-1 flex flex-col gap-4 py-2 ps-0 pe-3">
              <div>
                <li className="text-gray-700 flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm tracking-wider">Released 2024, January 24</span>
                </li>
                <li className="text-gray-700 flex items-center text-sm gap-2 mb-2">
                  <i className="text-amber-500">
                    <Smartphone className="w-4 h-4" />
                  </i>
                  <span className="text-sm tracking-wider">232g or 233g, 8.6mm thickness</span>
                </li>
                <li className="text-gray-700 flex items-center text-sm gap-2 mb-2">
                  <i className="text-amber-500">
                    <ChevronsLeftRight className="w-4 h-4" />
                  </i>
                  <span className="text-sm tracking-wider">Android 14, One UI 6.1</span>
                </li>
                <li className="text-gray-700 flex items-center gap-2 text-sm mb-2">
                  <i className="text-amber-500">
                    <MemoryStick className="w-4 h-4" />
                  </i>
                  <span className="text-sm tracking-wider">256GB/512GB/1TB storage, no card slot</span>
                </li>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex flex-col items-start justify-between p-2 rounded-lg ">
                  ...
                  <p className="text-gray-600 text-sm tracking-wider">1440x3120 pixels</p>
                </div>
            ...
            <div className="w-1/5 flex flex-col justify-between items-center border-x py-6 px-3">
            ...
            <div className="w-1/6 flex flex-col justify-between items-center py-6 ps-0 pe-3">
              <div className="text-center rounded-lg mb-4">
